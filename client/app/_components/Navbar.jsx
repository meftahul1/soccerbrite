    ...
    <div className='absolute top-0 left-0 w-full z-10'>
        ...
        <div className={`md:hidden ${showMenu ? 'fixed w-full' : 'h-0 w-0'}   right-0 top-0 bottom-0 overflow-hidden bg-white transition-all`}>
            ...
            <ul className='flex flex-col items-center gap-2 mt-5 px-5 text-lg font-medium'>
                ...
                <a onClick={() => setshowMenu(false)} href="#Events" className='px-4 py-2 rounded-full inline-block'>Events</a>
                <a onClick={() => setshowMenu(false)} href="#Testimonials" className='px-4 py-2 rounded-full inline-block'>Reviews</a>
            </ul>
        </div>
